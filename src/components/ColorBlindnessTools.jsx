  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="border border-gray-200 rounded-xl shadow-md p-6 flex flex-col items-center justify-center">
        ...
        className="px-4 py-2 bg-green-600 text-white rounded-md w-full text-base font-medium mt-2 hover:bg-green-700 transition-colors"
        >
        Start Camera
        </button>
      </div>
      ...
      <div className="max-w-sm sm:max-w-5xl m-auto grid grid-cols-1 md:grid-cols-3 gap-4">
        <img
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 mx-8">
      <div className="mb-6 text-center md:text-left">
        <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-2 flex items-center justify-center md:justify-start">
